...
/* -------------------------------------------------------------------------- */
void gf_init(gf_context *ctx, uint8_t *k)
{
    uint8_t rcon = 1;
    register uint8_t i;
...
/* -------------------------------------------------------------------------- */
void gf_encrypt_ecb(gf_context *ctx, uint8_t *buf)
{
    uint8_t i, rcon;
...
/* -------------------------------------------------------------------------- */
void gf_decrypt_ecb(gf_context *ctx, uint8_t *buf)
{
    uint8_t i, rcon;
