...
bool mail_setattachment(struct map_session_data *sd, struct mail_message *msg)
{
	...
	if(chrif_Parse_mailsetattachment())
	{
		ShowDebug("chrif_Parse_Mailsetattachment: Nenhum char-server encontrado! O Item/Zeny não pode ser enviado!");
		return false;
	}
