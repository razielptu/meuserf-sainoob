...
int atcommand_jobchange(const int fd, struct map_session_data* sd, const char* command, const char* message)
{
	...
	if (!message || !*message || sscanf(message, "%d %d", &job, &upper) < 1)
	{
		...
		if (!found) {
			...
			clif_displaymessage(fd, "   1 Espadachim         8 Sacerdote         15 Monget           22 Casamento");
			...
			clif_displaymessage(fd, "4023 Bebê Aprendiz   4030 Bebê Cavaleiro    4037 Babê Templário  4044 Babê Templário (Peco)");
			clif_displaymessage(fd, "4024 Bebê Espadachim 4031 Bebê Sacerdote    4038 Babê Monge      4045 Super Bebê");
			clif_displaymessage(fd, "4025 Babê Mago       4032 Babê Bruxo        4039 Babê Sábio      4046 Taekwon");
			clif_displaymessage(fd, "4026 Babê Arqueiro   4033 Babê Ferreiro     4040 Babê Rogue      4047 Mestre Taekwon");
			clif_displaymessage(fd, "4027 Babê Noviço     4034 Babê Caçador      4041 Babê Alquimista 4048 Mestre Taekwon (Voador)");
			clif_displaymessage(fd, "4028 Babê Mercador   4035 Babe Mercenário   4042 Babê Bardo      4049 Espiritualista");
			clif_displaymessage(fd, "4029 Babê Gatuno      4036 Baby Peco-Knight 4043 Baby Dancer");
			return -1;
		}
	}
...
int atcommand_go(const int fd, struct map_session_data* sd, const char* command, const char* message)
{
	...
	const struct {
		...
		{ MAP_MORROC,      158,  93 }, //  1=Morroc
		{ MAP_GEFFEN,      119,	 59 }, //  2=Geffen
		{ MAP_PAYON,       185,	100 }, //  3=Payon
		{ MAP_ALBERTA,     192, 147 }, //  4=Alberta
		{ MAP_IZLUDE,      128, 109 }, //  5=Izlude
		...
		{ MAP_NIFLHEIM,     24, 154 }, // 13=Niflheim
